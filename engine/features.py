...
def geminai(query):
    try:
        ...
        if not text and hasattr(response, "candidates") and response.candidates:
            # Fallback if SDK returns candidates list
                ...
                if hasattr(cand, "content") and hasattr(cand.content, "parts"):
                    ...
                    if parts:
                        ...
                        if maybe_text:
                            ...
                            break
        if not text:
            speak("Sorry, I couldn't find an answer. Please try rephrasing.")
            return ""
        filter_text = markdown_to_text(text)
        speak(filter_text)
        return filter_text
    except Exception as e:
        print("Error:", e)
        speak("I ran into a problem reaching the AI service.")
        return ""